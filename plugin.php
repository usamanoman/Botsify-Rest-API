<?php
/**
 * Plugin Name: Botsify REST API
 * Description: JSON-based REST API for WordPress, inherited from WP-RestV2.
 * Author: Usama Noman
 * Author URI: https://botsify.com
 * Version: 2.0
 * License: GPL2+
 */


require_once dirname( __FILE__ ) . '/featured-images/featured-images.php';
